/* O mesmo e2e, mas contra a INSTALAÇÃO: a API servindo o front na porta 3001,
   que é como a oficina vai usar. Prova a mesma origem, a CSP e o caminho
   inteiro do balcão sem `ng serve` no meio.
...
await pg.goto('http://127.0.0.1:3001/', { waitUntil: 'networkidle' });
...
await pg.goto('http://127.0.0.1:3001/#/placa');
...
// fila de filtros
await pg.goto('http://127.0.0.1:3001/#/filtros');
...
// clientes
await pg.goto('http://127.0.0.1:3001/#/clientes');
...
await pg.goto('http://127.0.0.1:3001/#/painel');
await pg.waitForSelector('.stat-v', { timeout: 15000 });
await pg.locator('nav.rail').hover();
...
await pg.goto('http://127.0.0.1:3001/#/painel'); await pg.waitForTimeout(1500);
await pg.screenshot({ path: '/tmp/claude-0/-home-claude/4bba41ce-547a-5d18-a48f-bdd8548ce138/scratchpad/tela-painel.png' });
await pg.goto('http://127.0.0.1:3001/#/placa'); await pg.waitForTimeout(600);
await pg.fill('input[name=placa]', 'IUA6376');
await pg.press('input[name=placa]', 'Enter');
